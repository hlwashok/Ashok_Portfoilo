        ...
        >
          ...
          <div className="bg-white dark:bg-[#101111] p-5 rounded-3xl shadow-lg shadow-gray-400/50 dark:shadow-black/30 ">
            <p className="text-base font-light">
              Hi, I am <span className="font-semibold">Ashok Kumar Sahoo</span>{" "}
              I am a{" "}
          ...
          <FeaturedCard
            ...
            desc="MERN Stack Intern at QLITH Innovation Pvt. Ltd."
          />
          ...
          <FeaturedCard
            ...
            title="2024-2022"
            desc="MCA ( Master of Computer Applications ) from GIFT Autonomous, Bhubaneswar."
          />
          ...
          <FeaturedCard
            ...
            title="2017-2020"
            desc="Graduted from Utkal University, Bhubaneswar."
          />
          ...
          <FeaturedCard
            ...
            title="2015-2017"
            desc="Intermediate from R.P +2 SCI RES College, Bidharpur, Cuttack."
          />
          ...
          <FeaturedCard
            ...
            title="2014-2015"
            desc="Schooling from A.N High School, Narasinghpur, Cuttack."
          />
        </motion.div>
      </motion.div>
